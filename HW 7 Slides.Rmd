...
ggplot(data = dat, aes(x = lambda)) + 
  geom_line(aes(y = wald, color = "dodgerblue")) +
  geom_line(aes(y = gamma, color = "burlywood")) +
  geom_line(aes(y = score, color = "indianred1")) +
  geom_line(aes(y = bootstrap, color = "seagreen")) +
  xlab("Lambda") +
  ylab("CI Width") +
