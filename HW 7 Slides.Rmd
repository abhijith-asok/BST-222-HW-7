...
>>>>>>> 1941ca2eebfb6e98fa248172c11c91bcd641a0fb
  return(ci)
}
```
...
#kat
score_ci2 <- function(N, rate, alpha = 0.05) {
  x <- rexp(N, rate = rate)
  xbar <- mean(x)
...
score_ci2_width <- function(N, rate, alpha = 0.05) {
  x <- rexp(N, rate = rate)
  xbar <- mean(x)
...
score_width <- sapply(rate, FUN = score_ci2_width, N = 10)
